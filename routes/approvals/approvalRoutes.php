...
Route::group(['prefix' => 'approvals'], function ()
{
    ...
    Route::post('amendment-approval-list', [
        \App\Http\Controllers\API\ContractHistoryAPIController::class,
        'getContractApprovals'
    ])->name('Contract amendment approval list');

    Route::post('approve-contract-amendment', [
        \App\Http\Controllers\API\ContractHistoryAPIController::class,
        'approveContract'
    ])->name('Approve contract amendment');

    Route::post('reject-contract-amendment', [
        \App\Http\Controllers\API\ContractHistoryAPIController::class,
        'rejectContract'
