...
return [
    ...
    'no_approval_record_found' => 'No approval record found. AR',
    'document_is_not_confirmed' => 'Document is not confirmed. AR',
    'policy_not_found' => 'Policy not found. AR',
    'you_do_not_have_access_to_approve_this_document' => 'You do not have access to approve this document. AR',
    'approval_level_not_found' => 'Approval level not found. AR',
    'failed_to_approve_document' => 'Failed to approve document. AR',
    'document_approved_successfully' => 'Document approved successfully. AR',
    'approval_level_id_is_required' => 'Approval Level ID is required. AR',
    'document_approved_id_is_required' => 'Document Approved ID is required. AR',
    'document_system_id_is_required' => 'Document System ID is required. AR',
    'rejected_comment_is_required' => 'Rejected comment is required. AR',
    'roll_level_order_is_required' => 'Roll Level Order is required. AR',
    'document_successfully_rejected' => 'Document successfully rejected. AR',
    'document_already_rejected' => 'Document is already rejected. AR',
    ...
    "amount" => "Amount AR",
    "contract_amount" => "Contract Amount AR",
